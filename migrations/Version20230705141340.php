 ...
 */
final class Version20230705141340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tags_route (tags_id INT NOT NULL, route_id INT NOT NULL, INDEX IDX_69A0D6218D7B4FB4 (tags_id), INDEX IDX_69A0D62134ECB4E6 (route_id), PRIMARY KEY(tags_id, route_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
